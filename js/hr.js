...
changePC('.wisdom-service-list-laowu', width, 200, 100, 250, 0);
changePC('.wisdom-service-list-waibao', width, 200, 100, 450, 0);
changePC('.wisdom-service-list-jiazheng', width, 200, 100, 650, 0);
changePC('.wisdom-service-list-zhongdian', width, 200, 100, 850, 0);
...
changePC('.wisdom-service-content-image', width, 700, 451, 700, 100);
...
changePC('.wisdom-feature-img', width, 1020, 800, 450, 50);
...
$('.wisdom-service-list-laowu').click(function(){
	$('.wisdom-service-li').removeClass('action');
	$(this).addClass('action');
	$('.wisdom-service-content').hide();
	$('.wisdom-service-content-laowu').show();
})
$('.wisdom-service-list-waibao').click(function(){
	$('.wisdom-service-li').removeClass('action');
	$(this).addClass('action');
	$('.wisdom-service-content').hide();
	$('.wisdom-service-content-waibao').show();
})
$('.wisdom-service-list-jiazheng').click(function(){
	$('.wisdom-service-li').removeClass('action');
	$(this).addClass('action');
	$('.wisdom-service-content').hide();
	$('.wisdom-service-content-jiazheng').show();
})
$('.wisdom-service-list-zhongdian').click(function(){
	$('.wisdom-service-li').removeClass('action');
	$(this).addClass('action');
	$('.wisdom-service-content').hide();
	$('.wisdom-service-content-zhongdian').show();
})
