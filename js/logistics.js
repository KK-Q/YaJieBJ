...
changePC('.wisdom-service-list-huiwu', width, 200, 100, 250, 0);
changePC('.wisdom-service-list-houqin', width, 200, 100, 550, 0);
changePC('.wisdom-service-list-qiantai', width, 200, 100, 800, 0);
...
changePC('.wisdom-feature-img', width, 924, 640, 500, 80);
...
$('.wisdom-service-list-huiwu').click(function(){
	$('.wisdom-service-li').removeClass('action');
	$(this).addClass('action');
	$('.wisdom-service-content').hide();
	$('.wisdom-service-content-huiwu').show();
})
$('.wisdom-service-list-houqin').click(function(){
	$('.wisdom-service-li').removeClass('action');
	$(this).addClass('action');
	$('.wisdom-service-content').hide();
	$('.wisdom-service-content-houqin').show();
})
$('.wisdom-service-list-qiantai').click(function(){
	$('.wisdom-service-li').removeClass('action');
	$(this).addClass('action');
	$('.wisdom-service-content').hide();
	$('.wisdom-service-content-qiantai').show();
})
